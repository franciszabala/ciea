 ...
 * @author Herman
 * @since 2014-12-16
 * @see http://www.javacodegeeks.com/2013/05/spring-from-the-trenches-adding-validation-to-a-rest-api.html
 */
@ControllerAdvice
public class RestErrorHandler {
    ...
    @ResponseBody
    public ErrorValidacionDTO processValidationError(MethodArgumentNotValidException ex) {
